...
public class RestClientProductRestService implements ProductRestService {

    private static final ParameterizedTypeReference<List<Product>> PRODUCTS_TYPE_REFERENCES =
            new ParameterizedTypeReference<List<Product>>() {
            };
    private final RestClient restClient;

    public RestClientProductRestService(RestClient restClient) {
